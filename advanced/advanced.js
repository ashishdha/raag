(function(){
  ...
  const COLUMN_DEFS = [
    ...
    { key: 'thaat',                   	 label: 'Thaat',                  preset: 'contracted', type: 'fk', lookup: 'thaat', filterable: true },
    ...
    { key: 'moorchhanaa_family',      	 label: 'Moorchhanaa Family',     preset: 'expanded',   type: 'int',          filterable: true },
    ...
    { key: 'ang',                     	 label: 'Ang',                    preset: 'maximum',    type: 'fk', lookup: 'ang', filterable: true },
    { key: 'samay',                   	 label: 'Samay',                  preset: 'maximum',    type: 'fk', lookup: 'samay', filterable: true },
    { key: 'taanpuraa_tuning',        	 label: 'Taanpuraa Tuning',       preset: 'maximum',    type: 'svar_specific', filterable: true },
    { key: 'creator',                 	 label: 'Creator',                preset: 'maximum',    type: 'fk', lookup: 'creator', filterable: true },
    { key: 'popularity',              	 label: 'Popularity',             preset: 'maximum',    type: 'fk', lookup: 'popularity', filterable: true },
